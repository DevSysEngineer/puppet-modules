...
Voor sommige processen, zoals firewall of SSH, is het niet voldoende om alleen te controleren of een proces draait. Vaak wil je ook verifiëren of het correct functioneert én performancegegevens kunnen uitlezen. Daarom zijn er voor bepaalde processen uitgebreide checks toegevoegd. De zichtbare statusregel van zo'n check hoort daarbij met het gecontroleerde onderdeel te beginnen en leesbare tekst te blijven; machinegerichte perfdata hoort in het perfdata-gedeelte en niet als `key=value`-tekst in de samenvatting. Checks met veel objecten, zoals netwerkinterfaces of containers, houden de korte statusregel compact en plaatsen begrensde details in de long output.
